...
3. In Karolina terminal `git clone paste_url_here`
4. `cd KPMS-IT4I-EX`
...
## Reproduce the run time graph from the lecture with Karolina times

1. On your laptop RStudio, edit the shell script to produce times for 1 to 128 cores
